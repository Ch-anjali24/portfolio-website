    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center space-y-8 mb-16">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-pink-500 via-yellow-400 to-green-400 bg-clip-text text-transparent">
            Hi, I'm CHINTALAPALLY ANJALI
          </h1>
          </div>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            I'm a passionate Full Stack Developer in building modern web
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg mb-16">
          ...
          <div className="space-y-6 text-left max-w-4xl mx-auto">
            <p className="text-lg text-gray-600">
              As a passionate learner, I’ve explored the full stack web
              development landscape by building projects using React, Tailwind
              CSS, Node.js, and MongoDB. I focus on learning by doing—applying
              concepts through hands-on practice, solving real-world problems,
              and continuously improving my skills. This self-driven approach
              has helped me grow into a capable and adaptable developer, ready
